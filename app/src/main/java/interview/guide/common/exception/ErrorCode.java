...
public enum ErrorCode {
    ...
    // ========== Agent 模块错误 9xxx ==========
    AGENT_INITIALIZATION_FAILED(9001, "Agent 初始化失败"),
    AGENT_DECISION_FAILED(9002, "Agent 决策失败"),
    AGENT_QUESTION_GENERATION_FAILED(9003, "Agent 问题生成失败"),
    AGENT_EVALUATION_FAILED(9004, "Agent 评估失败"),
    AGENT_REACT_INFERENCE_FAILED(9005, "Agent ReAct 推理失败"),
    AGENT_SESSION_EXPIRED(9006, "Agent 会话已过期");
